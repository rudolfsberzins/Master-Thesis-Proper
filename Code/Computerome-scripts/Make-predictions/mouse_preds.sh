...
python make_predictions.py Results/mouse_strict_w2v_model Results/mouse_gen_w2v_model Results/mouse_be_w2v_model Results/mouse_mentions_strict_real.pkl new_mouse_predictions
